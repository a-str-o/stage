...
class HeaderEstimationDesktopPro extends React.Component {
    ...
    render () {
        return <div className="desktop-pro">
            <div className="headerContainer">
                ...
                {this.state.estimationStatePro.activeStep !== 0 ? (
                    <p>{this.state.estimationStatePro.currentAdress}</p>
                ): ''}
            </div>
...
export default HeaderEstimationDesktopPro;